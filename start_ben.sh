...
PY="${BEN_PYTHON:-$HOME/anaconda3/envs/TF2/bin/python}"
...
if [[ ! -x "$PY" ]]; then
    ...
    echo "       set BEN_PYTHON to the interpreter of your conda env, e.g." >&2
    echo "       BEN_PYTHON=\$HOME/anaconda3/envs/TF2/bin/python ./start_ben.sh" >&2
    exit 1
fi
